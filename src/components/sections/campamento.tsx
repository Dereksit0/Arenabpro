...
import { CAMPAMENTO_VIDEOS } from "@/constants";
...
export default function Campamento() {
  ...
  return (
    <section
      ...
      aria-label="Campamento Arena B-PRO — testimonios de participantes"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Estos son algunos de los participantes que vivieron la experiencia del campamento Arena B-PRO. Sus palabras lo dicen todo.
          </motion.p>
        </motion.div>
        ...
        >
          {CAMPAMENTO_VIDEOS.map((video) => (
            <motion.div key={video.id} variants={fadeUp}>
              <CampVideoCard video={video} />
            </motion.div>
          ))}
        </motion.div>
      </div>
...
function CampVideoCard({ video }: { video: VideoItem }) {
  ...
  return (
    <div
      className="
        snap-start shrink-0 w-[72vw] sm:w-[48vw]
        lg:w-auto lg:shrink
